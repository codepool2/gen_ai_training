...
## 📚 PostGres DB
- After installing PostGres Db, We need to install PGVector extension
...
POST Rest Api: http://localhost:8080/api/chat/movieData POST
Data Sample used: [input sample](resources/input.json)

### Test your Api Using below Request

curl --location 'http://localhost:8080/api/chat/recommendedMovies' \
