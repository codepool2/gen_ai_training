...
public class RagClient {
    ...
    public String getResponse(String input) {
        ...
        List<String> responses = content.stream().map(String::valueOf).collect(Collectors.toList());
        responses.add(input);
    ...
    private List<KnowledgeStoreDto> getEmbeddingsGeneratedForUserQuery(String llmQuery) {

        List<KnowledgeStoreDto> knowledgeStoreDtos = knowledgeRepository.queryData(llmQuery);
        log.info("Responses retreived from DB: {}", knowledgeStoreDtos.stream().map(KnowledgeStoreDto::getDescription).collect(Collectors.joining("/n")));
    ...
    private String getAugmentedResponse(List<KnowledgeStoreDto> knowledgeStoreDtos, String input) {
        ...
        List<String> responses = content.stream().map(String::valueOf).toList();
